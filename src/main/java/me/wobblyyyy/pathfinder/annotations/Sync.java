 ...
 *
 * <p>
 * Sync operations are operations that have a result realized after the
 * completion of the execution of the annotated method.
 * </p>
 *
 * <p>
 * This means that the program will:
 * <ul>
 *     <li>Get to the code annotated with the {@code Sync} interface.</li>
 *     <li>Execute the code contained in the method's body.</li>
